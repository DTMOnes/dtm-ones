      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.content}>
          <div className={styles.item}>
            ...
            <p className={styles.value}>{player.height_cm} cm</p>
          </div>
          <div className={styles.item}>
            <p className={styles.label}>Nationality</p>
            <p className={styles.value}>{player.nationality}</p>
          </div>
          <div className={styles.item}>
            <p className={styles.label}>Last Club</p>
            <p className={styles.value}>{player.last_club ?? "-"}</p>
          </div>
        </div>
      </div>
    </motion.div>
