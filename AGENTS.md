...
- Server Actions use next-safe-action (ADR 0011). Throw `AppError` (or let libraries throw); `handleServerError` interprets. Follow `.cursor/rules/next-safe-action.mdc`.
