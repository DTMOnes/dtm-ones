...
**Owner**:
A User who can do everything Staff can, and can create other Users, change their role, and delete them — not their own role or themselves, which another Owner must change or delete. The dashboard always has at least one Owner.
